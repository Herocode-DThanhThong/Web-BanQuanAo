      ...
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide text-base font-bold uppercase dark:text-coolGray-50">
              Product
            </h3>
          ...
          <div className="space-y-3">
            <h3 className="uppercase dark:text-coolGray-50 text-base font-bold">
              Developers
            </h3>
            <ul className="space-y-3">
              <li>
          ...
          <div className="space-y-3">
            <div className="uppercase dark:text-coolGray-50 text-base font-bold">
              Social media
            </div>
            <div className="flex justify-start space-x-3">
              ...
              <span title="Instagram" className="flex items-center p-1">
                <svg
                  ...
                  viewBox="0 0 32 32"
                  fill="currentColor"
                  className="w-5 h-5 fill-current bg-gradient-to-r from-purple-500 to-pink-500"
                >
